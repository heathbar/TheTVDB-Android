        ...
        if(b != null) {
            ...
            if(defaultScale == ZoomableImageView.DEFAULT_SCALE_FIT_INSIDE) {               
                if(imgWidth > containerWidth) {           
                	...
                	scale = Math.min((float)containerWidth / imgWidth, (float)containerHeight / imgHeight);
                    //scale = (float)containerHeight / imgHeight;
                    initX = (containerWidth - (int)(imgWidth * scale))/2;
                    initY = (containerHeight - (int)(imgHeight * scale))/2;
